...
SELECT lc.IndexText, MONTH(lc.DateExch) MontExch, AVG(lc.last_ClouseCourse-lc.Adj_CloseCourse) Avg_MonthCourseDifference,
    RANK() OVER(Partition BY lc.IndexText ORDER BY AVG(lc.last_ClouseCourse-lc.Adj_CloseCourse) DESC) rank_no
